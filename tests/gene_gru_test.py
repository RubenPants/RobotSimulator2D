...
class TestGruNodeGene(unittest.TestCase):
    ...
    def test_weight_ih(self):
        ...
        self.assertTrue(gru.weight_ih_full.shape == (3, 0))
        self.assertTrue(gru.weight_ih.shape == (3, 0))
        
        # Add connection
        gru.add_input_key(config.genome, 1)
        gru.update_weight_ih()
        self.assertTrue(gru.weight_ih_full.shape == (3, 1))
        self.assertTrue(gru.weight_ih.shape == (3, 1))
        first_col = copy.deepcopy(gru.weight_ih[:, 0])
        self.assertTrue(all(gru.weight_ih_full[:, 0] == gru.weight_ih[:, 0]))
        ...
        gru.update_weight_ih()
        self.assertTrue(gru.weight_ih_full.shape == (3, 2))
        self.assertTrue(gru.weight_ih.shape == (3, 2))
        self.assertTrue(all(gru.weight_ih_full[:, 0] == gru.weight_ih[:, 0]))
        self.assertTrue(all(gru.weight_ih[:, 0] == first_col))
        third_col = copy.deepcopy(gru.weight_ih[:, 1])
        self.assertTrue(all(gru.weight_ih_full[:, 1] == gru.weight_ih[:, 1]))
        
        # Add third key, positioned in between the two other keys
        gru.add_input_key(config.genome, 2)
        gru.update_weight_ih()
        self.assertTrue(gru.weight_ih_full.shape == (3, 3))
        self.assertTrue(gru.weight_ih.shape == (3, 3))
        self.assertTrue(all(gru.weight_ih_full[:, 0] == gru.weight_ih[:, 0]))
        self.assertTrue(all(gru.weight_ih[:, 0] == first_col))
        second_col = copy.deepcopy(gru.weight_ih[:, 1])
        self.assertTrue(all(gru.weight_ih_full[:, 1] == gru.weight_ih[:, 1]))
        self.assertTrue(all(gru.weight_ih_full[:, 2] == gru.weight_ih[:, 2]))
        self.assertTrue(all(gru.weight_ih[:, 2] == third_col))
        ...
        self.assertTrue(gru.weight_ih_full.shape == (3, 3))
        self.assertTrue(gru.weight_ih.shape == (3, 2))
        self.assertTrue(all(gru.weight_ih_full[:, 0] == first_col))
        self.assertTrue(all(gru.weight_ih_full[:, 1] == gru.weight_ih[:, 0]))
        self.assertTrue(all(gru.weight_ih[:, 0] == second_col))
        self.assertTrue(all(gru.weight_ih_full[:, 2] == gru.weight_ih[:, 1]))
        self.assertTrue(all(gru.weight_ih[:, 1] == third_col))
        ...
        self.assertTrue(all(gru.weight_ih[:, 0] == first_col))
        self.assertTrue(all(gru.weight_ih_full[:, 1] == gru.weight_ih[:, 1]))
        self.assertTrue(all(gru.weight_ih[:, 1] == second_col))
        self.assertTrue(all(gru.weight_ih_full[:, 2] == gru.weight_ih[:, 2]))
        self.assertTrue(all(gru.weight_ih[:, 2] == third_col))
    ...
    def test_mutate(self):
        ...
        first_col = copy.deepcopy(gru.weight_ih_full[:, 0])
        second_col = copy.deepcopy(gru.weight_ih_full[:, 1])
        third_col = copy.deepcopy(gru.weight_ih_full[:, 2])
        forth_col = copy.deepcopy(gru.weight_ih_full[:, 3])
        ...
        self.assertTrue(all(gru.weight_ih[:, 1] == second_col))
        self.assertTrue(all(gru.weight_ih[:, 3] == forth_col))
        
        # Check if other two columns have changed (almost impossible to obtain exactly the same after 100x mutation)
        self.assertTrue(not all(gru.weight_ih[:, 0] == first_col))
        self.assertTrue(not all(gru.weight_ih[:, 2] == third_col))
