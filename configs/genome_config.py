...
class GenomeConfig(BaseConfig):
    ...
    def __init__(self):
        ...
        self.enabled_mutate_rate: float = .05
        ...
        self.gru_init_stdev: float = 1.5
        # The maximum allowed GRU-weight value, values above this will be clipped  [def=5]
        self.gru_max_value: float = 5.
        # The minimum allowed GRU-weight value, values below this will be clipped  [def=-5]
        self.gru_min_value: float = -5.
        # The standard deviation of the zero-centered gaussian from which a GRU value mutation is drawn  [def=0.05]
        self.gru_mutate_power: float = .2
        ...
        self.initial_conn = D_FULL_DIRECT
