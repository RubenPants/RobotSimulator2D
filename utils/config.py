...
# --> NOISE <-- #
NOISE_TIME = 0.01  # Alpha in Gaussian distribution for time noise during game-progress, max 0.04 deviation [def=0.02]
NOISE_SENSOR_ANGLE = 0.002  # Alpha in Gaussian distribution for angular sensor, max 1.25° deviation [def=0.002]
NOISE_SENSOR_DIST = 0.02  # Alpha in Gaussian distribution for distance sensor, max 5cm deviation [def=0.2]
NOISE_SENSOR_PROXY = 0.02  # Alpha in Gaussian distribution for proximity sensor, max 5cm deviation [def=0.02]
