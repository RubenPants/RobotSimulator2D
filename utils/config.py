...
# --> TARGET SPECIFIC <-- #
TARGET_REACHED = 0.5  # Target is reached when within this range, expressed in meters [def=0.5]
...
NOISE_SENSOR_DIST = 0.005  # Alpha in Gaussian distribution for distance sensor, max ~1.5cm deviation [def=0.005]
NOISE_SENSOR_PROXY = 0.005  # Alpha in Gaussian distribution for proximity sensor, max ~1.5cm deviation [def=0.005]
